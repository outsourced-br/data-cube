...
internal sealed class SystemTextCubeJsonSerializerAdapter : ICubeJsonSerializerAdapter
{
  public static readonly ICubeJsonSerializerAdapter Instance = new SystemTextCubeJsonSerializerAdapter();

  private SystemTextCubeJsonSerializerAdapter()
  {
  }
